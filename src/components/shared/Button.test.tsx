...
describe("Button", () => {
  it("renders button with class primary when type primary", () => {
    render(<Button type="primary" />);
    const primaryButton = screen.getByRole("button");
    expect(primaryButton).toHaveClass("primary");
  });
  it("renders button with class secondary when typpe secondary", () => {
    render(<Button type="secondary" />);
    const secondaryButton = screen.getByRole("button");
    expect(secondaryButton).toHaveClass("secondary");
  });
  it("renders button with class noHover when noHover is true", () => {
